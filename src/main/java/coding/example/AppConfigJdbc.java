...
public class AppConfigJdbc {
    ...
    @Autowired
    public AppConfigJdbc(DataSource dataSource, Environment environment, ResourceLoader resourceLoader) {
...
//    }
    ...
    public AdminController adminController(){
        return new AdminController( userService(), vegetableService(), imageService());
    }

    @Bean
    public PageController pageController(){
        return new PageController( vegetableService(), createSpoonacularService(), createApplicationData());
    }
    @Bean
    ...
    public VegetableService vegetableService(){
        return new VegetableService(databaseService(), imageService());
    }
