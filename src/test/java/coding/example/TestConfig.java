...
public class TestConfig {
    ...
    @Autowired
    public TestConfig(Environment environment, ResourceLoader resourceLoader) {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                .requestMatchers("/static/**", "/logout/**","/login/**","/performlogin/**",
                        "/health/**", "/error/**", "/loginerror/**", "/hello/**") .permitAll()
    ...
    VegetableRepository vegRepo = mock(VegetableRepository.class);
